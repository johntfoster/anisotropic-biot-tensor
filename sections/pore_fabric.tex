...
point exists and is unique. Differentiating along the conformal
...
quadratic potential is strictly convex and the mineral term contributes a
positive-definite stiffness in the same strain, so
\(\mathbb{D}+\phi_{s0}\mathbb{C}_s\) is positive definite there and the
stationary point of
\eqref{eq:fabric-equilibrium} is unique; minimizing at fixed
