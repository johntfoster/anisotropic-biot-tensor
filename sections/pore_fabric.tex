...
orientation is a modeling choice; in the conformal specialization it is immaterial
...
\eqref{eq:fabric-commuting-work}. In the conformal model the shape terms were absent because
