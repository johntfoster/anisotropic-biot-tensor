...
\(K_s=2.5K_*\), shear modulus \(5K_*/6\), and
...
The comparison with \(k_c=0\) retains shape compliance; the conformal
...
the fabric model from the conformal specialization. The modulus sweep
...
\begin{figure}[htbp]
 ...
 uncoupled and conformal curves in panel (a) coincide at zero shear reaction. All moduli and states are synthetic.}
