...
\begin{figure}[htbp]
 \centering
 \resizebox{\textwidth}{!}{\import{build/insight/}{fabric_pressure_shear.pgf}}
...
\begin{figure}[htbp]
 \centering
 \resizebox{\textwidth}{!}{\import{build/insight/}{fabric_comparison.pgf}}
...
\(\mathbf\varepsilon_A=\tfrac12\log\mathbf G\), but solve
...
\begin{figure}[htbp]
 \centering
 \resizebox{\textwidth}{!}{\import{build/insight/}{fabric_finite.pgf}}
