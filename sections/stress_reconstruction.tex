...
equal moduli measured under hydrostatic stress. Under isotropy, spherical
strain produces hydrostatic stress, so these loading conditions give the
same linearized volume response. We therefore write
\(K=\mathcal{K}\) and \(K_s=\mathcal{K}_s\) for the usual reference bulk
moduli in isotropic specializations.
...
We express the distention in terms of the same drained logarithmic
