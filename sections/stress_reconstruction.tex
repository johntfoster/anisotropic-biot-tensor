...
\begin{align}
 ...
 \pder{W_{\mathrm{dr}}}{\mathbf\varepsilon}
...
mixture volume. At zero pressure the coupled energy must recover \(W_{\mathrm{dr}}\).
...
\(W_{\mathrm{dr}}\). Positive mineral stiffness
