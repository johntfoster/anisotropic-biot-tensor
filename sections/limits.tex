...
\end{equation}
These are the elastic scalar relations of \citet{foster2026poroplastic}.
...
\end{equation}
These identities hold while the material follows the specified elastic
response. They verify finite homogeneous mineral compression, in addition
to the reference linear relations.
