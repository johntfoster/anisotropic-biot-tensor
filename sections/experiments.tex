...
The isotropic comparison uses the same \(\mathcal{K}_s=28K_*\), drained
spherical-strain modulus \(\mathcal{K}=7K_*\), and reference solid fraction. Its
...
because the skeleton shape term vanishes and \(\mathcal{K}_s\) is the same.
