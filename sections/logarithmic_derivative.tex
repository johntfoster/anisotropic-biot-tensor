...
stress and Biot tensor. Let \(\mathbf C=\mathbf F^T\mathbf F\) be the
right Cauchy--Green tensor and \(\mathbf\varepsilon=\tfrac12\log\mathbf C\)
its logarithmic strain. If \(\mathbf T\) is symmetric and conjugate to
\(\mathbf\varepsilon\), then
\begin{align}
...
the derivative self-adjoint. The derivative maps the metric \(\mathbf C\)
to the identity \(\mathbf I\).
Consequently,
\begin{align}
 \tr\mathbf\tau
