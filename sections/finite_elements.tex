...
below instead use the linearized fabric equilibrium to determine coupling
...
are \(\phi_{s0}=0.9\), \(\mathcal{K}_s=2.5\), mineral shear modulus
\(\mu_s=5/6\), \(\mathcal{K}=1\), \(K_f=8\),
...
problem as \(q_L/\mathcal{K}\) tends to zero; they need not reproduce its series
at a finite load.
...
The following experiments use the coupling to predict boundary reactions,
